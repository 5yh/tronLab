...
#############获取全部数据################################################
    ...
    value_data=all_data_lower.filter("transType == 'trx'") \
                             .select('to','value')
    ...
    final_easy_features_data.write.option("header", True).csv('file:///mnt/blockchain02/tronLabData/easy_features')
